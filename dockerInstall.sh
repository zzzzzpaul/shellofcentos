...
echo '{"registry-mirrors":["https://registry.docker-cn.com","http://hub-mirror.c.163.com","https://docker.mirrors.ustc.edu.cn","https://22hp57es.mirror.aliyuncs.com"],"insecure-registries":["192.168.0.45"]}' > /etc/docker/daemon.json &&\
